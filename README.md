...
- [Using pip](src/python.md#using-pip)
  ...
  - [Project requirements](src/python.md#project-requirements)
  ...
  - [Check a specific package](src/python.md#check-a-specific-package)
- [Virtual environments (venv)](src/python.md#virtual-environments-venv)
...
- [Compiling a release](src/python.md#compiling-a-release)
  ...
  - [Creation of dist](src/python.md#creation-of-dist)
...
- [git config](src/git.md#git-config)
    - [Global edit](src/git.md#global-edit)
    - [Aliases](src/git.md#aliases--shortcuts)
    - [Name and email](src/git.md#name-and-email)
